...
struct ListScreenDecorator: View {
    ...
    var body: some View {
        ...
        .secFR2(sdofihad: HeaderViewFrameAnchorPreferenceKey.self, dsfoih: $scrollViewHeaderContentFrame)
        .secFR2(sdofihad: TalkListScreenFramePreferenceKey.self, dsfoih: $scrollViewFrame)
        .toolbar {
